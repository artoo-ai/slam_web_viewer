...
const LAYERS: { key: keyof LayerVisibility; label: string; tip: string }[] = [
  ...
  { key: 'scan_main', label: 'Scan Band',
    tip: 'The main nav/SLAM band: the 0.15–0.45 m cloud slice that pointcloud_to_laserscan flattens into the 2D /scan feeding slam_toolbox and the costmap’s main obstacle_layer. White dots at their true height — a slab ABOVE the red low-obstacle band — showing which part of the point cloud drives mapping and obstacle avoidance.' },
